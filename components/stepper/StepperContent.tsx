...
const StepperContent: FC<StepContentOneProps> = ({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center w-full gap-10 md:gap-16`}>
      {lastStep && (
        <div className="flex items-center justify-center text-gray-300 bg-green-700 rounded-full w-14 h-14">
          <CheckIcon />
        </div>
      )}
